...
ARTISTS_AND_PAINTINGS = [
        ...
        "paintings": [
            {
                ...
                "description_full": "Картина была написана под впечатлением от убийства Александра II и жестокого подавления народовольцев. Репин работал над полотном три года. Когда картина была выставлена, она произвела на зрителей настолько сильное впечатление, что один посетитель порезал её ножом.",
                ...
                "image_url": f"{BASE_URL}/repin_ivan_grozny.jpg",
                "wikimedia_source": "https://commons.wikimedia.org/wiki/File:REPIN_Ivan_Terrible%26Ivan.jpg",
                "license_type": "PD",
                "difficulty": 1,
                "popularity_rank": 1,
            },
            {
                ...
                "description_full": "Репин увидел бурлаков впервые на Неве в 1869 году и был поражён контрастом между отдыхающей публикой и измученными рабочими. На картине изображены 11 конкретных людей — у каждого своя история и характер.",
                "interesting_facts": json.dumps([
                    ...
                    "Картина была куплена великим князем Владимиром Александровичем"
                ], ensure_ascii=False),
                "image_url": f"{BASE_URL}/repin_burlaki.jpg",
                "wikimedia_source": "https://commons.wikimedia.org/wiki/File:Ilya_Repin_-_Barge_Haulers_on_the_Volga.jpg",
                "license_type": "PD",
                "difficulty": 1,
                "popularity_rank": 2,
            },
            {
                ...
                "description_full": "Репин показывает возвращение революционера из ссылки. Реакция каждого члена семьи различна — мать узнаёт сына, жена в растерянности, дети по-разному реагируют на незнакомца.",
                "interesting_facts": json.dumps([
                ...
                "image_url": f"{BASE_URL}/repin_ne_jdali.jpg",
                "wikimedia_source": "https://commons.wikimedia.org/wiki/File:They_did_not_Expect_Him.jpg",
                "license_type": "PD",
                "difficulty": 2,
                "popularity_rank": 5,
            },
        ...
        "paintings": [
            {
                ...
                "description_full": "Суриков работал над картиной 3 года. Образ Морозовой долго не давался художнику — пока он не встретил старообрядческую монахиню с фанатичным взглядом. Картина поражает размерами: 587 × 304 см.",
                "interesting_facts": json.dumps([
                ...
                "image_url": f"{BASE_URL}/surikov_morozova.jpg",
                "wikimedia_source": "https://commons.wikimedia.org/wiki/File:Boyaryna_Morozova_by_V.Surikov.jpg",
                "license_type": "PD",
                "difficulty": 1,
                "popularity_rank": 3,
            },
            {
                ...
                "description_full": "Суриков изобразил не саму казнь, а момент перед ней — прощание с близкими, молитвы, горе. Пётр I на коне смотрит холодным взглядом победителя.",
                "interesting_facts": json.dumps([
                ...
                "image_url": f"{BASE_URL}/surikov_strelcy.jpg",
                "wikimedia_source": "https://commons.wikimedia.org/wiki/File:Surikov_streltsi.jpg",
                "license_type": "PD",
                "difficulty": 2,
                "popularity_rank": 6,
            },
        ...
        "paintings": [
            {
                ...
                "description_full": "Васнецов работал над картиной почти 20 лет — с 1881 по 1898 год. Илья Муромец написан с крестьянина Ивана Петрова, Добрыня — с самого Васнецова и его родственников.",
                "interesting_facts": json.dumps([
                    "Васнецов работал над картиной около 20 лет",
                    "Илья Муромец написан с владимирского крестьянина",
                    "Картина куплена Третьяковым в год завершения"
                ], ensure_ascii=False),
                "image_url": f"{BASE_URL}/vasnetsov_bogatyri.jpg",
                "wikimedia_source": "https://commons.wikimedia.org/wiki/File:Viktor_Vasnetsov_Bogatyrs.jpg",
                "license_type": "PD",
                "difficulty": 1,
                "popularity_rank": 4,
            },
            {
                ...
                "description_full": "Образ Алёнушки возник у Васнецова когда он увидел простую крестьянскую девушку с огромными грустными глазами. Картина вдохновлена русской сказкой о сестрице Алёнушке и братце Иванушке.",
                "interesting_facts": json.dumps([
                ...
                "image_url": f"{BASE_URL}/vasnetsov_alenushka.jpg",
        ...
        "paintings": [
            {
                ...
                "period": "XIX век",
                "style": "реализм",
                "description_short": "Величественный пейзаж с бескрайним небом и маленькой церковью на обрыве — размышление о вечности и одиночестве человека перед лицом природы.",
                "description_full": "Сам Левитан называл эту картину самой своей заветной. Маленькая церковь и погост на краю обрыва — символ хрупкости человеческого существования. Небо занимает три четверти полотна.",
                "interesting_facts": json.dumps([
                    "Левитан называл эту картину 'самой моей заветной'",
                    "Написана на берегу озера Удомля",
                    "Небо написано под впечатлением от музыки Бетховена"
                ], ensure_ascii=False),
                "image_url": f"{BASE_URL}/levitan_vechniy_pokoj.jpg",
                "wikimedia_source": "https://commons.wikimedia.org/wiki/File:LevitanAboveEternalPeace.jpg",
                "license_type": "PD",
                "difficulty": 2,
                "popularity_rank": 8,
            },
    ...
    {
        "artist": {
            "name_ru": "Алексей Саврасов",
            "name_en": "Alexei Savrasov",
            "birth_year": 1830,
            "death_year": 1897,
            "movement": "Передвижники",
            "bio_short": "Алексей Кондратьевич Саврасов — основоположник лирического пейзажа в русской живописи. Его картина Грачи прилетели стала символом русской весны.",
        },
        "paintings": [
            {
                ...
                "description_full": "Саврасов написал эту картину в Костромской губернии в 1871 году. Несмотря на личную трагедию — незадолго до этого умерла его дочь — картина полна надежды и весенней радости.",
                "interesting_facts": json.dumps([
                ...
                "image_url": f"{BASE_URL}/savrasov_grachi.jpg",
                "wikimedia_source": "https://commons.wikimedia.org/wiki/File:RooksBackOfSavrasov.jpg",
                "license_type": "PD",
                "difficulty": 1,
                "popularity_rank": 9,
            },
        ...
        "paintings": [
            {
                ...
                "period": "XIX век",
                "style": "реализм",
                "description_short": "Медведица с тремя медвежатами в утреннем сосновом лесу. Картина стала одной из самых узнаваемых в русском искусстве.",
                "description_full": "Шишкин написал лес, а медведей по его просьбе дорисовал художник-анималист Константин Савицкий. Оба подписали картину, но Третьяков стёр подпись Савицкого.",
                "interesting_facts": json.dumps([
                ...
                "image_url": f"{BASE_URL}/shishkin_utro.jpg",
                "wikimedia_source": "https://commons.wikimedia.org/wiki/File:Shishkin_Ivan_Morning_in_a_Pine_Forest.jpg",
                "license_type": "PD",
                "difficulty": 1,
                "popularity_rank": 10,
            },
...
async def seed():
    ...
    await conn.execute("DELETE FROM paintings")
    ...
    for item in ARTISTS_AND_PAINTINGS:
        ...
        for p in item["paintings"]:
            ...
            print(f"   🖼️  {p['title_ru']} (id={painting_id})")
